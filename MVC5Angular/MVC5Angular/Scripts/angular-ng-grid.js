...
(function(window, $) {
    ...
    ngGridDirectives.directive("ngCell", [
        "$compile", "$domUtilityService", function($compile, domUtilityService) {
            var ngCell = {
                scope: false,
                compile: function() {
                    return {
    ...
    ngGridDirectives.directive("ngGrid", [
        "$compile", "$filter", "$templateCache", "$sortService", "$domUtilityService", "$utilityService", "$timeout", "$parse", "$http", "$q", function($compile, $filter, $templateCache, sortService, domUtilityService, $utils, $timeout, $parse, $http, $q) {
            var ngGridDirective = {
                scope: true,
                compile: function() {
                    return {
    ...
    ngGridDirectives.directive("ngRow", [
        "$compile", "$domUtilityService", "$templateCache", function($compile, domUtilityService, $templateCache) {
            var ngRow = {
                scope: false,
                compile: function() {
                    return {
